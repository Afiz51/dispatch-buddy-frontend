            ...
            <div className="hero__button">
              <Link to="/user-signup">
                <button
                  ...
                  className="btn customer__button"
                >
        ...
        <section className="top__notch">
          <div>
            ...
            <p style={{ width: 650, fontSize: 18, marginTop: 20 }}>
              Quickly integrate powerful solutions that gives you more
        ...
        <section className="client__testimonies">
          <div className="client__testimonies__div">
            ...
            <p>
              ...
              leo a eget risus nunc. Arcu amet nibh arcu risus vulputate. Amet,
              ac nec, nunc viverra massa blandit nec enim volutpat. Cursus
              pretium velit eget justo, turpis.
            </p>
